...
export const metadata: Metadata = {
  title: 'Envíos Express en Moto (30-90 min) · Envíos DosRuedas Mar del Plata',
  description: 'Servicio de cadetería y mensajería express inmediata en Mar del Plata. Repartidor exclusivo punto a punto, custodia digital y seguimiento en vivo.',
};
...
export default function EnviosExpressPage() {
 ...
 <HiBolt className=\text-sm\ /> Prioritario Inmediato
 </span>

 <h1 className=\text-4xl sm:text-5xl lg:text-6xl font-display uppercase tracking-tight leading-none text-brand-white\>
 ENVÍOS EXPRESS <br />
 <span className=\text-brand-yellow\>30 A 90 MINUTOS</span>
 </h1>

 <p className=\text-base sm:text-lg text-brand-white/90 font-sans font-light leading-relaxed max-w-xl\>
 Asignación de cadete en moto exclusivo punto a punto para trámites, sobres, documentación y paquetería urgente en todo Mar del Plata.
 </p>
 ...
 >
 <span>Calcular Tarifa en Mapa</span>
 <HiArrowRight className=\text-sm\ />
 </Link>

 <a
 href=\https://wa.me/542236602699?text=Hola,%20necesito%20un%20Env%C3%ADo%20Express\
 target=\_blank\
 rel=\noopener noreferrer\
 ...
 />
 <div className=\absolute top-3 right-3 bg-brand-blue text-brand-yellow border border-brand-yellow px-2.5 py-1 rounded text-[9px] font-bold font-mono uppercase\>
 MAPA EN VIVO
 </div>
 </div>
 <div className=\flex items-center justify-between text-xs font-mono\>
 <span>VELOCIDAD ESTIMADA</span>
 <span className=\text-brand-yellow font-bold\>30 - 90 Min</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <div className=\text-center max-w-3xl mx-auto space-y-3\>
 <span className=\px-4 py-1.5 rounded-full text-xs font-subheading uppercase tracking-widest bg-brand-blue-deep border border-brand-white/20 text-brand-yellow font-bold\>
 ¿Cómo Funciona el Express?
 </span>
 <h2 className=\text-3xl sm:text-4xl lg:text-5xl font-display uppercase tracking-tight\>
 Máxima Rapidez y Seguridad Urbana
 </h2>
 </div>
 ...
 Asignamos al mensajero más cercano a tu ubicación en Mar del Plata para buscar el paquete en minutos.
 </p>
 </div>
 </div>
 ...
 <p className=\text-sm text-brand-white/80 font-sans font-light leading-relaxed\>
 Trazabilidad y aviso de entrega en tiempo real con confirmación al remitente vía WhatsApp.
 </p>
 </div>
 </div>
 ...
 <p className=\text-sm text-brand-white/80 font-sans font-light leading-relaxed\>
 Llegada directa al destinatario, cobro contra entrega si aplica y rendición inmediata del dinero.
 </p>
 </div>
 </div>
 </div>
